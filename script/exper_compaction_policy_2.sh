...
# exper name
current_exper=compaction_pri_2_overwrite
...
# exper name
current_exper=compaction_pri_2_mixgraph_read
result_dir=~/ExperResults/exper_name/$current_exper
sudo rm -rf $result_dir
mkdir $result_dir
#sudo rm -rf ~/mnt/*
...
# exper name
current_exper=compaction_pri_2_mixgraph_write
result_dir=~/ExperResults/exper_name/$current_exper
sudo rm -rf $result_dir
mkdir $result_dir
#sudo rm -rf ~/mnt/*
